...
entity axi4lite_gbe2_muxdemux is
   port(
      ...
      ipb_mosi_arr : out t_ipb_gbe2_mosi_arr;
      ipb_miso_arr : in t_ipb_gbe2_miso_arr
   );
end entity;     

architecture axi4lite_gbe2_muxdemux_a of axi4lite_gbe2_muxdemux is 
   
   constant c_block_start_index: integer := c_nof_register_blocks;
   
   signal ipb_mosi_arr_i   : t_ipb_gbe2_mosi_arr;
...
begin   
   ...
   gen_1: if c_total_nof_blocks > 1 generate      
      ...
      begin
         hit := axi4lite_gbe2_demux(ipb_mosi.addr);
