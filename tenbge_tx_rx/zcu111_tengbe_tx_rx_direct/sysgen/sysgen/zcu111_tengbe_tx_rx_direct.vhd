...
begin
  ...
  dat_del_q_net <= din;
  join_x6 : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_join_x2 
  port map (
  ...
  split_x6 : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_split_x1 
  port map (
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_join_x5 is
  port (
    in1 : in std_logic_vector( 32-1 downto 0 );
    in2 : in std_logic_vector( 32-1 downto 0 );
    in3 : in std_logic_vector( 32-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_join_x5;
architecture structural of zcu111_tengbe_tx_rx_direct_join_x5 is 
  signal concatenate_y_net : std_logic_vector( 128-1 downto 0 );
  signal reinterpret1_output_port_net : std_logic_vector( 32-1 downto 0 );
  signal reinterpret2_output_port_net : std_logic_vector( 32-1 downto 0 );
  signal reinterpret3_output_port_net : std_logic_vector( 32-1 downto 0 );
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_split_x5 is
  port (
    bus_in : in std_logic_vector( 128-1 downto 0 );
    msb_out4 : out std_logic_vector( 32-1 downto 0 );
    out3 : out std_logic_vector( 32-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_split_x5;
architecture structural of zcu111_tengbe_tx_rx_direct_split_x5 is 
  signal reinterpret4_output_port_net : std_logic_vector( 32-1 downto 0 );
  signal reinterpret3_output_port_net : std_logic_vector( 32-1 downto 0 );
  signal reinterpret2_output_port_net : std_logic_vector( 32-1 downto 0 );
  signal reinterpret1_output_port_net : std_logic_vector( 32-1 downto 0 );
...
begin
  dout <= reinterpret_out_output_port_net;
  dat_del_q_net <= din;
  join_x6 : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_join_x5 
  port map (
    in1 => reinterpret1_output_port_net,
    in2 => reinterpret2_output_port_net,
    in3 => reinterpret3_output_port_net,
  ...
  split_x6 : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_split_x5 
  port map (
    bus_in => reinterpret_output_port_net,
    msb_out4 => reinterpret4_output_port_net,
    out3 => reinterpret3_output_port_net,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_trig_delay_x3 is
  port (
    d : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_trig_delay_x3;
architecture structural of zcu111_tengbe_tx_rx_direct_trig_delay_x3 is 
  signal register4_q_net : std_logic_vector( 1-1 downto 0 );
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_we_delay_x3 is
  port (
    d : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_we_delay_x3;
architecture structural of zcu111_tengbe_tx_rx_direct_we_delay_x3 is 
  signal register4_q_net : std_logic_vector( 1-1 downto 0 );
  signal mux1_y_net : std_logic_vector( 1-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
begin
  ...
  trig_delay : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_trig_delay_x3 
  port map (
    d => txsnap_and_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  we_delay : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_we_delay_x3 
  port map (
    d => mux1_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_rxbadctr_x1 is
  port (
    out_reg : in std_logic_vector( 32-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_rxbadctr_x1;
architecture structural of zcu111_tengbe_tx_rx_direct_rxbadctr_x1 is 
  signal rxbadctr_del2_q_net : std_logic_vector( 32-1 downto 0 );
  signal cast_gw_dout_net : std_logic_vector( 32-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_rxctr_x1 is
  port (
    out_reg : in std_logic_vector( 32-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_rxctr_x1;
architecture structural of zcu111_tengbe_tx_rx_direct_rxctr_x1 is 
  signal rxctr_del2_q_net : std_logic_vector( 32-1 downto 0 );
  signal cast_gw_dout_net : std_logic_vector( 32-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_rxctr_ed_x1 is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_rxctr_ed_x1;
architecture structural of zcu111_tengbe_tx_rx_direct_rxctr_ed_x1 is 
  signal edge_op_y_net : std_logic_vector( 1-1 downto 0 );
  signal rxctr_and_y_net : std_logic_vector( 1-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_rxeofctr_x1 is
  port (
    out_reg : in std_logic_vector( 32-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_rxeofctr_x1;
architecture structural of zcu111_tengbe_tx_rx_direct_rxeofctr_x1 is 
  signal rxeofctr_del2_q_net : std_logic_vector( 32-1 downto 0 );
  signal cast_gw_dout_net : std_logic_vector( 32-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_rxofctr_x1 is
  port (
    out_reg : in std_logic_vector( 32-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_rxofctr_x1;
architecture structural of zcu111_tengbe_tx_rx_direct_rxofctr_x1 is 
  signal rxofctr_del2_q_net : std_logic_vector( 32-1 downto 0 );
  signal cast_gw_dout_net : std_logic_vector( 32-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_buscreate_x4 is
  port (
    in1 : in std_logic_vector( 1-1 downto 0 );
    in2 : in std_logic_vector( 1-1 downto 0 );
    in3 : in std_logic_vector( 64-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_buscreate_x4;
architecture structural of zcu111_tengbe_tx_rx_direct_buscreate_x4 is 
  signal concatenate_y_net : std_logic_vector( 102-1 downto 0 );
  signal assert_led_up_dout_net : std_logic_vector( 1-1 downto 0 );
  signal assert_led_rx_dout_net : std_logic_vector( 1-1 downto 0 );
  signal assert_data_in_dout_net : std_logic_vector( 64-1 downto 0 );
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_io_delay_x3 is
  port (
    d : in std_logic_vector( 102-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_io_delay_x3;
architecture structural of zcu111_tengbe_tx_rx_direct_io_delay_x3 is 
  signal register4_q_net : std_logic_vector( 102-1 downto 0 );
  signal concatenate_y_net : std_logic_vector( 102-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_edge_detect_x11 is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_edge_detect_x11;
architecture structural of zcu111_tengbe_tx_rx_direct_edge_detect_x11 is 
  signal edge_op_y_net : std_logic_vector( 1-1 downto 0 );
  signal slice3_y_net : std_logic_vector( 1-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_add_gen_x5 is
  port (
    din : in std_logic_vector( 128-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    go : in std_logic_vector( 1-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_add_gen_x5;
architecture structural of zcu111_tengbe_tx_rx_direct_add_gen_x5 is 
  signal slice2_y_net : std_logic_vector( 13-1 downto 0 );
  signal delay6_q_net : std_logic_vector( 128-1 downto 0 );
  signal logical6_y_net : std_logic_vector( 1-1 downto 0 );
  signal concat_y_net : std_logic_vector( 32-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  edge_detect : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_edge_detect_x11 
  port map (
    in_x0 => slice3_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_dram_munge_x5 is
  port (
    din : in std_logic_vector( 128-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    init : in std_logic_vector( 1-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_dram_munge_x5;
architecture structural of zcu111_tengbe_tx_rx_direct_dram_munge_x5 is 
  signal data_choice_y_net : std_logic_vector( 128-1 downto 0 );
  signal we_choice_y_net : std_logic_vector( 1-1 downto 0 );
  signal cast_dout_net : std_logic_vector( 128-1 downto 0 );
  signal mux1_y_net_x0 : std_logic_vector( 1-1 downto 0 );
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_edge_detect_x12 is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_edge_detect_x12;
architecture structural of zcu111_tengbe_tx_rx_direct_edge_detect_x12 is 
  signal edge_op_y_net : std_logic_vector( 1-1 downto 0 );
  signal delay1_q_net : std_logic_vector( 1-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_basic_ctrl_x5 is
  port (
    din : in std_logic_vector( 128-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    trig : in std_logic_vector( 1-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_basic_ctrl_x5;
architecture structural of zcu111_tengbe_tx_rx_direct_basic_ctrl_x5 is 
  signal data_choice_y_net : std_logic_vector( 128-1 downto 0 );
  signal we_choice_y_net : std_logic_vector( 1-1 downto 0 );
  signal register6_q_net : std_logic_vector( 1-1 downto 0 );
  signal edge_op_y_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  dram_munge : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_dram_munge_x5 
  port map (
    din => cast_dout_net,
    we => mux1_y_net,
    init => edge_op_y_net,
  ...
  edge_detect : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_edge_detect_x12 
  port map (
    in_x0 => delay1_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_calc_add_x5 is
  port (
    in_x0 : in std_logic_vector( 13-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_calc_add_x5;
architecture structural of zcu111_tengbe_tx_rx_direct_calc_add_x5 is 
  signal mux_y_net : std_logic_vector( 13-1 downto 0 );
  signal add_del_q_net : std_logic_vector( 13-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_munge_in_x5 is
  port (
    din : in std_logic_vector( 128-1 downto 0 );
    dout : out std_logic_vector( 128-1 downto 0 )
  );
end zcu111_tengbe_tx_rx_direct_munge_in_x5;
architecture structural of zcu111_tengbe_tx_rx_direct_munge_in_x5 is 
  signal reinterpret_out_output_port_net : std_logic_vector( 128-1 downto 0 );
  signal dat_del_q_net : std_logic_vector( 128-1 downto 0 );
  signal concatenate_y_net : std_logic_vector( 128-1 downto 0 );
  signal reinterpret1_output_port_net : std_logic_vector( 32-1 downto 0 );
...
begin
  dout <= reinterpret_out_output_port_net;
  dat_del_q_net <= din;
  join_x6 : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_join 
  port map (
    in1 => reinterpret1_output_port_net,
    in2 => reinterpret2_output_port_net,
    in3 => reinterpret3_output_port_net,
  ...
  split_x6 : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_split 
  port map (
    bus_in => reinterpret_output_port_net,
    msb_out4 => reinterpret4_output_port_net,
    out3 => reinterpret3_output_port_net,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_bram_x5 is
  port (
    addr : in std_logic_vector( 13-1 downto 0 );
    data_in : in std_logic_vector( 128-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_bram_x5;
architecture structural of zcu111_tengbe_tx_rx_direct_bram_x5 is 
  signal add_del_q_net : std_logic_vector( 13-1 downto 0 );
  signal dat_del_q_net : std_logic_vector( 128-1 downto 0 );
  signal we_del_q_net : std_logic_vector( 1-1 downto 0 );
  signal convert_addr_dout_net : std_logic_vector( 13-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  calc_add : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_calc_add_x5 
  port map (
    in_x0 => add_del_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  munge_in : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_munge_in_x5 
  port map (
    din => dat_del_q_net,
    dout => reinterpret_out_output_port_net
  );
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_ctrl_x5 is
  port (
    zcu111_tengbe_tx_rx_direct_gbe1_rxs_ss_ctrl_user_data_out : in std_logic_vector( 32-1 downto 0 );
    in_reg : out std_logic_vector( 32-1 downto 0 )
  );
end zcu111_tengbe_tx_rx_direct_ctrl_x5;
architecture structural of zcu111_tengbe_tx_rx_direct_ctrl_x5 is 
  signal reint1_output_port_net : std_logic_vector( 32-1 downto 0 );
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_ctrl_combine_x5 is
  port (
    in1 : in std_logic_vector( 28-1 downto 0 );
    in2 : in std_logic_vector( 1-1 downto 0 );
    in3 : in std_logic_vector( 2-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_ctrl_combine_x5;
architecture structural of zcu111_tengbe_tx_rx_direct_ctrl_combine_x5 is 
  signal concatenate_y_net : std_logic_vector( 32-1 downto 0 );
  signal reinterpret4_output_port_net_x0 : std_logic_vector( 28-1 downto 0 );
  signal circ_or_y_net : std_logic_vector( 1-1 downto 0 );
  signal reinterpret2_output_port_net : std_logic_vector( 2-1 downto 0 );
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_ctrl_split_x5 is
  port (
    bus_in : in std_logic_vector( 32-1 downto 0 );
    msb_out4 : out std_logic_vector( 28-1 downto 0 );
    out3 : out std_logic_vector( 1-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_ctrl_split_x5;
architecture structural of zcu111_tengbe_tx_rx_direct_ctrl_split_x5 is 
  signal reinterpret4_output_port_net : std_logic_vector( 28-1 downto 0 );
  signal slice3_y_net : std_logic_vector( 1-1 downto 0 );
  signal reinterpret2_output_port_net : std_logic_vector( 2-1 downto 0 );
  signal slice1_y_net : std_logic_vector( 1-1 downto 0 );
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_status_x5 is
  port (
    out_reg : in std_logic_vector( 32-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_status_x5;
architecture structural of zcu111_tengbe_tx_rx_direct_status_x5 is 
  signal assert_reg_dout_net : std_logic_vector( 32-1 downto 0 );
  signal concat_y_net : std_logic_vector( 32-1 downto 0 );
  signal cast_gw_dout_net : std_logic_vector( 32-1 downto 0 );
  signal clk_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_ss_x5 is
  port (
    din : in std_logic_vector( 102-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    trig : in std_logic_vector( 1-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_ss_x5;
architecture structural of zcu111_tengbe_tx_rx_direct_ss_x5 is 
  signal arm_or_y_net : std_logic_vector( 1-1 downto 0 );
  signal register4_q_net_x0 : std_logic_vector( 102-1 downto 0 );
  signal register4_q_net_x1 : std_logic_vector( 1-1 downto 0 );
  signal register4_q_net_x2 : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  add_gen : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_add_gen_x5 
  port map (
    din => data_choice_y_net,
    we => we_choice_y_net,
    go => register6_q_net,
  ...
  basic_ctrl : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_basic_ctrl_x5 
  port map (
    din => cast_dout_net,
    we => register4_q_net_x1,
    trig => register4_q_net_x2,
  ...
  bram : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_bram_x5 
  port map (
    addr => add_del_q_net,
    data_in => dat_del_q_net,
    we => we_del_q_net,
  ...
  ctrl : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_ctrl_x5 
  port map (
    zcu111_tengbe_tx_rx_direct_gbe1_rxs_ss_ctrl_user_data_out => zcu111_tengbe_tx_rx_direct_gbe1_rxs_ss_ctrl_user_data_out_net,
    in_reg => reint1_output_port_net
  );
  ctrl_combine : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_ctrl_combine_x5 
  port map (
    in1 => reinterpret4_output_port_net,
    in2 => circ_or_y_net,
    in3 => reinterpret2_output_port_net,
  ...
  ctrl_split : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_ctrl_split_x5 
  port map (
    bus_in => reint1_output_port_net,
    msb_out4 => reinterpret4_output_port_net,
    out3 => slice3_y_net,
  ...
  status : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_status_x5 
  port map (
    out_reg => concat_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_rxs_x1 is
  port (
    in_led_up : in std_logic_vector( 1-1 downto 0 );
    in_led_rx : in std_logic_vector( 1-1 downto 0 );
    in_data_in : in std_logic_vector( 64-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_rxs_x1;
architecture structural of zcu111_tengbe_tx_rx_direct_rxs_x1 is 
  signal arm_or_y_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  buscreate : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_buscreate_x4 
  port map (
    in1 => assert_led_up_dout_net,
    in2 => assert_led_rx_dout_net,
    in3 => assert_data_in_dout_net,
  ...
  io_delay : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_io_delay_x3 
  port map (
    d => concatenate_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  ss : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_ss_x5 
  port map (
    din => register4_q_net_x1,
    we => register4_q_net,
    trig => register4_q_net_x0,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_rxvldctr_x1 is
  port (
    out_reg : in std_logic_vector( 32-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_rxvldctr_x1;
architecture structural of zcu111_tengbe_tx_rx_direct_rxvldctr_x1 is 
  signal rxvldctr_del2_q_net : std_logic_vector( 32-1 downto 0 );
  signal cast_gw_dout_net : std_logic_vector( 32-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_txctr_x1 is
  port (
    out_reg : in std_logic_vector( 32-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_txctr_x1;
architecture structural of zcu111_tengbe_tx_rx_direct_txctr_x1 is 
  signal txctr_del2_q_net : std_logic_vector( 32-1 downto 0 );
  signal cast_gw_dout_net : std_logic_vector( 32-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_txctr_ed_x1 is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_txctr_ed_x1;
architecture structural of zcu111_tengbe_tx_rx_direct_txctr_ed_x1 is 
  signal edge_op_y_net : std_logic_vector( 1-1 downto 0 );
  signal txctr_and_y_net : std_logic_vector( 1-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_txfullctr_x1 is
  port (
    out_reg : in std_logic_vector( 32-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_txfullctr_x1;
architecture structural of zcu111_tengbe_tx_rx_direct_txfullctr_x1 is 
  signal txfullctr_del2_q_net : std_logic_vector( 32-1 downto 0 );
  signal cast_gw_dout_net : std_logic_vector( 32-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_txofctr_x1 is
  port (
    out_reg : in std_logic_vector( 32-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_txofctr_x1;
architecture structural of zcu111_tengbe_tx_rx_direct_txofctr_x1 is 
  signal txofctr_del2_q_net : std_logic_vector( 32-1 downto 0 );
  signal cast_gw_dout_net : std_logic_vector( 32-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_buscreate_x5 is
  port (
    in1 : in std_logic_vector( 1-1 downto 0 );
    in2 : in std_logic_vector( 1-1 downto 0 );
    in3 : in std_logic_vector( 1-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_buscreate_x5;
architecture structural of zcu111_tengbe_tx_rx_direct_buscreate_x5 is 
  signal concatenate_y_net : std_logic_vector( 102-1 downto 0 );
  signal assert_link_up_dout_net : std_logic_vector( 1-1 downto 0 );
  signal assert_led_tx_dout_net : std_logic_vector( 1-1 downto 0 );
  signal assert_tx_full_dout_net : std_logic_vector( 1-1 downto 0 );
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_io_delay_x4 is
  port (
    d : in std_logic_vector( 102-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_io_delay_x4;
architecture structural of zcu111_tengbe_tx_rx_direct_io_delay_x4 is 
  signal register4_q_net : std_logic_vector( 102-1 downto 0 );
  signal concatenate_y_net : std_logic_vector( 102-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_edge_detect_x9 is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_edge_detect_x9;
architecture structural of zcu111_tengbe_tx_rx_direct_edge_detect_x9 is 
  signal edge_op_y_net : std_logic_vector( 1-1 downto 0 );
  signal slice3_y_net : std_logic_vector( 1-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_add_gen_x4 is
  port (
    din : in std_logic_vector( 128-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    go : in std_logic_vector( 1-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_add_gen_x4;
architecture structural of zcu111_tengbe_tx_rx_direct_add_gen_x4 is 
  signal convert_dout_net : std_logic_vector( 14-1 downto 0 );
  signal register5_q_net : std_logic_vector( 1-1 downto 0 );
  signal delay_q_net : std_logic_vector( 1-1 downto 0 );
  signal delay4_q_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  edge_detect : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_edge_detect_x9 
  port map (
    in_x0 => slice3_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_dram_munge_x4 is
  port (
    din : in std_logic_vector( 128-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    init : in std_logic_vector( 1-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_dram_munge_x4;
architecture structural of zcu111_tengbe_tx_rx_direct_dram_munge_x4 is 
  signal data_choice_y_net : std_logic_vector( 128-1 downto 0 );
  signal we_choice_y_net : std_logic_vector( 1-1 downto 0 );
  signal cast_dout_net : std_logic_vector( 128-1 downto 0 );
  signal mux1_y_net_x0 : std_logic_vector( 1-1 downto 0 );
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_edge_detect_x10 is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_edge_detect_x10;
architecture structural of zcu111_tengbe_tx_rx_direct_edge_detect_x10 is 
  signal edge_op_y_net : std_logic_vector( 1-1 downto 0 );
  signal delay1_q_net : std_logic_vector( 1-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_basic_ctrl_x4 is
  port (
    din : in std_logic_vector( 128-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    trig : in std_logic_vector( 1-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_basic_ctrl_x4;
architecture structural of zcu111_tengbe_tx_rx_direct_basic_ctrl_x4 is 
  signal data_choice_y_net : std_logic_vector( 128-1 downto 0 );
  signal we_choice_y_net : std_logic_vector( 1-1 downto 0 );
  signal register6_q_net : std_logic_vector( 1-1 downto 0 );
  signal edge_op_y_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  dram_munge : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_dram_munge_x4 
  port map (
    din => cast_dout_net,
    we => mux1_y_net,
    init => edge_op_y_net,
  ...
  edge_detect : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_edge_detect_x10 
  port map (
    in_x0 => delay1_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_calc_add_x4 is
  port (
    in_x0 : in std_logic_vector( 13-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_calc_add_x4;
architecture structural of zcu111_tengbe_tx_rx_direct_calc_add_x4 is 
  signal mux_y_net : std_logic_vector( 13-1 downto 0 );
  signal add_del_q_net : std_logic_vector( 13-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_munge_in_x4 is
  port (
    din : in std_logic_vector( 128-1 downto 0 );
    dout : out std_logic_vector( 128-1 downto 0 )
  );
end zcu111_tengbe_tx_rx_direct_munge_in_x4;
architecture structural of zcu111_tengbe_tx_rx_direct_munge_in_x4 is 
  signal reinterpret_out_output_port_net : std_logic_vector( 128-1 downto 0 );
  signal dat_del_q_net : std_logic_vector( 128-1 downto 0 );
  signal concatenate_y_net : std_logic_vector( 128-1 downto 0 );
  signal reinterpret1_output_port_net : std_logic_vector( 32-1 downto 0 );
...
begin
  dout <= reinterpret_out_output_port_net;
  dat_del_q_net <= din;
  join_x6 : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_join_x0 
  port map (
    in1 => reinterpret1_output_port_net,
    in2 => reinterpret2_output_port_net,
    in3 => reinterpret3_output_port_net,
  ...
  split_x6 : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_split_x0 
  port map (
    bus_in => reinterpret_output_port_net,
    msb_out4 => reinterpret4_output_port_net,
    out3 => reinterpret3_output_port_net,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_bram_x4 is
  port (
    addr : in std_logic_vector( 13-1 downto 0 );
    data_in : in std_logic_vector( 128-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_bram_x4;
architecture structural of zcu111_tengbe_tx_rx_direct_bram_x4 is 
  signal add_del_q_net : std_logic_vector( 13-1 downto 0 );
  signal dat_del_q_net : std_logic_vector( 128-1 downto 0 );
  signal we_del_q_net : std_logic_vector( 1-1 downto 0 );
  signal convert_addr_dout_net : std_logic_vector( 13-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  calc_add : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_calc_add_x4 
  port map (
    in_x0 => add_del_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  munge_in : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_munge_in_x4 
  port map (
    din => dat_del_q_net,
    dout => reinterpret_out_output_port_net
  );
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_ctrl_x4 is
  port (
    zcu111_tengbe_tx_rx_direct_gbe1_txs_ss_ctrl_user_data_out : in std_logic_vector( 32-1 downto 0 );
    in_reg : out std_logic_vector( 32-1 downto 0 )
  );
end zcu111_tengbe_tx_rx_direct_ctrl_x4;
architecture structural of zcu111_tengbe_tx_rx_direct_ctrl_x4 is 
  signal reint1_output_port_net : std_logic_vector( 32-1 downto 0 );
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_ctrl_combine_x4 is
  port (
    in1 : in std_logic_vector( 28-1 downto 0 );
    in2 : in std_logic_vector( 1-1 downto 0 );
    in3 : in std_logic_vector( 2-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_ctrl_combine_x4;
architecture structural of zcu111_tengbe_tx_rx_direct_ctrl_combine_x4 is 
  signal concatenate_y_net : std_logic_vector( 32-1 downto 0 );
  signal reinterpret4_output_port_net_x0 : std_logic_vector( 28-1 downto 0 );
  signal circ_or_y_net : std_logic_vector( 1-1 downto 0 );
  signal reinterpret2_output_port_net : std_logic_vector( 2-1 downto 0 );
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_ctrl_split_x4 is
  port (
    bus_in : in std_logic_vector( 32-1 downto 0 );
    msb_out4 : out std_logic_vector( 28-1 downto 0 );
    out3 : out std_logic_vector( 1-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_ctrl_split_x4;
architecture structural of zcu111_tengbe_tx_rx_direct_ctrl_split_x4 is 
  signal reinterpret4_output_port_net : std_logic_vector( 28-1 downto 0 );
  signal slice3_y_net : std_logic_vector( 1-1 downto 0 );
  signal reinterpret2_output_port_net : std_logic_vector( 2-1 downto 0 );
  signal slice1_y_net : std_logic_vector( 1-1 downto 0 );
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_status_x4 is
  port (
    out_reg : in std_logic_vector( 32-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_status_x4;
architecture structural of zcu111_tengbe_tx_rx_direct_status_x4 is 
  signal concat_y_net : std_logic_vector( 32-1 downto 0 );
  signal cast_gw_dout_net : std_logic_vector( 32-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_ss_x4 is
  port (
    din : in std_logic_vector( 102-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    trig : in std_logic_vector( 1-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_ss_x4;
architecture structural of zcu111_tengbe_tx_rx_direct_ss_x4 is 
  signal arm_or_y_net : std_logic_vector( 1-1 downto 0 );
  signal register4_q_net_x0 : std_logic_vector( 102-1 downto 0 );
  signal register4_q_net_x1 : std_logic_vector( 1-1 downto 0 );
  signal register4_q_net_x2 : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  add_gen : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_add_gen_x4 
  port map (
    din => data_choice_y_net,
    we => we_choice_y_net,
    go => register6_q_net,
  ...
  basic_ctrl : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_basic_ctrl_x4 
  port map (
    din => cast_dout_net,
    we => register4_q_net_x1,
    trig => register4_q_net_x2,
  ...
  bram : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_bram_x4 
  port map (
    addr => add_del_q_net,
    data_in => dat_del_q_net,
    we => we_del_q_net,
  ...
  ctrl : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_ctrl_x4 
  port map (
    zcu111_tengbe_tx_rx_direct_gbe1_txs_ss_ctrl_user_data_out => zcu111_tengbe_tx_rx_direct_gbe1_txs_ss_ctrl_user_data_out_net,
    in_reg => reint1_output_port_net
  );
  ctrl_combine : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_ctrl_combine_x4 
  port map (
    in1 => reinterpret4_output_port_net,
    in2 => circ_or_y_net,
    in3 => reinterpret2_output_port_net,
  ...
  ctrl_split : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_ctrl_split_x4 
  port map (
    bus_in => reint1_output_port_net,
    msb_out4 => reinterpret4_output_port_net,
    out3 => slice3_y_net,
  ...
  status : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_status_x4 
  port map (
    out_reg => concat_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_trig_delay_x4 is
  port (
    d : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_trig_delay_x4;
architecture structural of zcu111_tengbe_tx_rx_direct_trig_delay_x4 is 
  signal register4_q_net : std_logic_vector( 1-1 downto 0 );
  signal txsnap_and_y_net : std_logic_vector( 1-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_we_delay_x4 is
  port (
    d : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_we_delay_x4;
architecture structural of zcu111_tengbe_tx_rx_direct_we_delay_x4 is 
  signal register4_q_net : std_logic_vector( 1-1 downto 0 );
  signal constant_op_net : std_logic_vector( 1-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_txs_x1 is
  port (
    in_link_up : in std_logic_vector( 1-1 downto 0 );
    in_led_tx : in std_logic_vector( 1-1 downto 0 );
    in_tx_full : in std_logic_vector( 1-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_txs_x1;
architecture structural of zcu111_tengbe_tx_rx_direct_txs_x1 is 
  signal arm_or_y_net : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe1_led_up_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  buscreate : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_buscreate_x5 
  port map (
    in1 => assert_link_up_dout_net,
    in2 => assert_led_tx_dout_net,
    in3 => assert_tx_full_dout_net,
  ...
  io_delay : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_io_delay_x4 
  port map (
    d => concatenate_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  ss : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_ss_x4 
  port map (
    din => register4_q_net_x1,
    we => register4_q_net,
    trig => register4_q_net_x0,
  ...
  trig_delay : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_trig_delay_x4 
  port map (
    d => txsnap_and_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  we_delay : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_we_delay_x4 
  port map (
    d => constant_op_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_txvldctr_x1 is
  port (
    out_reg : in std_logic_vector( 32-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end zcu111_tengbe_tx_rx_direct_txvldctr_x1;
architecture structural of zcu111_tengbe_tx_rx_direct_txvldctr_x1 is 
  signal txvldctr_del2_q_net : std_logic_vector( 32-1 downto 0 );
  signal cast_gw_dout_net : std_logic_vector( 32-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  rxbadctr : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_rxbadctr_x1 
  port map (
    out_reg => rxbadctr_del2_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  rxctr : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_rxctr_x1 
  port map (
    out_reg => rxctr_del2_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  rxctr_ed : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_rxctr_ed_x1 
  port map (
    in_x0 => rxctr_and_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  rxeofctr : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_rxeofctr_x1 
  port map (
    out_reg => rxeofctr_del2_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  rxofctr : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_rxofctr_x1 
  port map (
    out_reg => rxofctr_del2_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  rxs : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_rxs_x1 
  port map (
  ...
  rxvldctr : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_rxvldctr_x1 
  port map (
    out_reg => rxvldctr_del2_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  txctr : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_txctr_x1 
  port map (
    out_reg => txctr_del2_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  txctr_ed : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_txctr_ed_x1 
  port map (
    in_x0 => txctr_and_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  txfullctr : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_txfullctr_x1 
  port map (
    out_reg => txfullctr_del2_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  txofctr : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_txofctr_x1 
  port map (
    out_reg => txofctr_del2_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  txs : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_txs_x1 
  port map (
  ...
  txvldctr : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_txvldctr_x1 
  port map (
    out_reg => txvldctr_del2_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxbadctr
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_rxbadctr_x0 is
  port (
    ...
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    zcu111_tengbe_tx_rx_direct_gbe2_rxbadctr_user_data_in : out std_logic_vector( 32-1 downto 0 )
  );
...
begin
  rxbadctr_del2_q_net <= out_reg;
  zcu111_tengbe_tx_rx_direct_gbe2_rxbadctr_user_data_in <= cast_gw_dout_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
  io_delay : entity xil_defaultlib.sysgen_delay_1e4098e040 
  port map (
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxctr
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_rxctr_x0 is
  port (
    ...
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    zcu111_tengbe_tx_rx_direct_gbe2_rxctr_user_data_in : out std_logic_vector( 32-1 downto 0 )
  );
...
begin
  rxctr_del2_q_net <= out_reg;
  zcu111_tengbe_tx_rx_direct_gbe2_rxctr_user_data_in <= cast_gw_dout_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
  io_delay : entity xil_defaultlib.sysgen_delay_1e4098e040 
  port map (
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxctr_ed
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxeofctr
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_rxeofctr is
  port (
    ...
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    zcu111_tengbe_tx_rx_direct_gbe2_rxeofctr_user_data_in : out std_logic_vector( 32-1 downto 0 )
  );
...
begin
  rxeofctr_del2_q_net <= out_reg;
  zcu111_tengbe_tx_rx_direct_gbe2_rxeofctr_user_data_in <= cast_gw_dout_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
  io_delay : entity xil_defaultlib.sysgen_delay_1e4098e040 
  port map (
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxofctr
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_rxofctr is
  port (
    ...
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    zcu111_tengbe_tx_rx_direct_gbe2_rxofctr_user_data_in : out std_logic_vector( 32-1 downto 0 )
  );
...
begin
  rxofctr_del2_q_net <= out_reg;
  zcu111_tengbe_tx_rx_direct_gbe2_rxofctr_user_data_in <= cast_gw_dout_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
  io_delay : entity xil_defaultlib.sysgen_delay_1e4098e040 
  port map (
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/buscreate
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/io_delay
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/ss/add_gen/edge_detect
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/ss/add_gen
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/ss/basic_ctrl/dram_munge
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/ss/basic_ctrl/edge_detect
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/ss/basic_ctrl
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/ss/bram/calc_add
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/ss/bram/munge_in/join
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/ss/bram/munge_in/split
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/ss/bram/munge_in
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
begin
  dout <= reinterpret_out_output_port_net;
  dat_del_q_net <= din;
  join_x6 : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_join_x1 
  port map (
    in1 => reinterpret1_output_port_net,
    in2 => reinterpret2_output_port_net,
    in3 => reinterpret3_output_port_net,
  ...
  split_x6 : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_split_x2 
  port map (
    bus_in => reinterpret_output_port_net,
    msb_out4 => reinterpret4_output_port_net,
    out3 => reinterpret3_output_port_net,
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/ss/bram
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_bram_x1 is
  port (
    ...
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_addr : out std_logic_vector( 13-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_data_in : out std_logic_vector( 128-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_we : out std_logic_vector( 1-1 downto 0 )
  );
...
begin
  ...
  dat_del_q_net <= data_in;
  we_del_q_net <= we;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_addr <= convert_addr_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_data_in <= convert_din1_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_we <= convert_we_dout_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/ss/ctrl
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_ctrl_x0 is
  port (
    zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out : in std_logic_vector( 32-1 downto 0 );
    in_reg : out std_logic_vector( 32-1 downto 0 )
  );
end zcu111_tengbe_tx_rx_direct_ctrl_x0;
architecture structural of zcu111_tengbe_tx_rx_direct_ctrl_x0 is 
  signal reint1_output_port_net : std_logic_vector( 32-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out_net : std_logic_vector( 32-1 downto 0 );
  signal io_delay_q_net : std_logic_vector( 32-1 downto 0 );
  signal slice_reg_y_net : std_logic_vector( 32-1 downto 0 );
begin
  in_reg <= reint1_output_port_net;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out_net <= zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out;
  io_delay : entity xil_defaultlib.sysgen_delay_71a4e0c2b5 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
    d => zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out_net,
    q => io_delay_q_net
  );
  slice_reg : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_xlslice 
  generic map (
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/ss/ctrl_combine
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/ss/ctrl_split
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/ss/status
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_status is
  port (
    ...
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_status_user_data_in : out std_logic_vector( 32-1 downto 0 )
  );
...
begin
  concat_y_net <= out_reg;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_status_user_data_in <= cast_gw_dout_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
  io_delay : entity xil_defaultlib.sysgen_delay_71a4e0c2b5 
  port map (
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/ss
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_ss is
  port (
    ...
    ce_1 : in std_logic;
    arm_out : out std_logic_vector( 1-1 downto 0 );
    goto_113430955_we1 : out std_logic_vector( 1-1 downto 0 );
    goto_113430955_we4 : out std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_addr : out std_logic_vector( 13-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_data_in : out std_logic_vector( 128-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_we : out std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_status_user_data_in : out std_logic_vector( 32-1 downto 0 )
...
begin
  ...
  register4_q_net_x1 <= we;
  register4_q_net_x2 <= trig;
  goto_113430955_we1 <= we_choice_y_net;
  goto_113430955_we4 <= logical6_y_net;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_addr <= convert_addr_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_data_in <= convert_din1_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_we <= convert_we_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out_net <= zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out;
  ...
  port map (
    zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out => zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out_net,
    in_reg => reint1_output_port_net
  );
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/trig_delay
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs/we_delay
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
architecture structural of zcu111_tengbe_tx_rx_direct_we_delay_x1 is 
  signal register4_q_net : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_rx_valid_net : std_logic_vector( 1-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
  signal register2_q_net : std_logic_vector( 1-1 downto 0 );
  signal register1_q_net : std_logic_vector( 1-1 downto 0 );
...
begin
  q <= register4_q_net;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_valid_net <= d;
  clk_net <= clk_1;
  ce_net <= ce_1;
  register2 : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_xlregister 
  generic map (
  ...
  port map (
    en => "1",
    rst => "0",
    d => zcu111_tengbe_tx_rx_direct_gbe2_rx_valid_net,
    clk => clk_net,
    ce => ce_net,
    q => register0_q_net
  );
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxs
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
architecture structural of zcu111_tengbe_tx_rx_direct_rxs is 
  signal arm_or_y_net : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_led_up_net : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_led_rx_net : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_rx_data_net : std_logic_vector( 64-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_rx_valid_net : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_rx_source_ip_net : std_logic_vector( 32-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_rx_end_of_frame_net : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_rx_bad_frame_net : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_rx_overrun_net : std_logic_vector( 1-1 downto 0 );
  signal rxsnap_and_y_net : std_logic_vector( 1-1 downto 0 );
  signal convert_addr_dout_net : std_logic_vector( 13-1 downto 0 );
  signal convert_din1_dout_net : std_logic_vector( 128-1 downto 0 );
  signal convert_we_dout_net : std_logic_vector( 1-1 downto 0 );
...
begin
  arm_out <= arm_or_y_net;
  zcu111_tengbe_tx_rx_direct_gbe2_led_up_net <= in_led_up;
  zcu111_tengbe_tx_rx_direct_gbe2_led_rx_net <= in_led_rx;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_data_net <= in_data_in;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_valid_net <= in_valid_in;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_source_ip_net <= in_ip_in;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_end_of_frame_net <= in_eof_in;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_bad_frame_net <= in_bad_frame;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_overrun_net <= in_overrun;
  rxsnap_and_y_net <= trig;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_addr <= convert_addr_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_data_in <= convert_din1_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_we <= convert_we_dout_net;
  ...
  port map (
    din => zcu111_tengbe_tx_rx_direct_gbe2_led_up_net,
    dout => assert_led_up_dout_net
  );
  assert_led_rx : entity xil_defaultlib.xlpassthrough 
  generic map (
  ...
  port map (
    din => zcu111_tengbe_tx_rx_direct_gbe2_led_rx_net,
    dout => assert_led_rx_dout_net
  );
  assert_data_in : entity xil_defaultlib.xlpassthrough 
  generic map (
  ...
  port map (
    din => zcu111_tengbe_tx_rx_direct_gbe2_rx_data_net,
    dout => assert_data_in_dout_net
  );
  assert_valid_in : entity xil_defaultlib.xlpassthrough 
  generic map (
  ...
  port map (
    din => zcu111_tengbe_tx_rx_direct_gbe2_rx_valid_net,
    dout => assert_valid_in_dout_net
  );
  assert_ip_in : entity xil_defaultlib.xlpassthrough 
  generic map (
  ...
  port map (
    din => zcu111_tengbe_tx_rx_direct_gbe2_rx_source_ip_net,
    dout => assert_ip_in_dout_net
  );
  assert_eof_in : entity xil_defaultlib.xlpassthrough 
  generic map (
  ...
  port map (
    din => zcu111_tengbe_tx_rx_direct_gbe2_rx_end_of_frame_net,
    dout => assert_eof_in_dout_net
  );
  assert_bad_frame : entity xil_defaultlib.xlpassthrough 
  generic map (
  ...
  port map (
    din => zcu111_tengbe_tx_rx_direct_gbe2_rx_bad_frame_net,
    dout => assert_bad_frame_dout_net
  );
  assert_overrun : entity xil_defaultlib.xlpassthrough 
  generic map (
  ...
  port map (
    din => zcu111_tengbe_tx_rx_direct_gbe2_rx_overrun_net,
    dout => assert_overrun_dout_net
  );
end structural;
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/rxvldctr
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_rxvldctr is
  port (
    ...
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    zcu111_tengbe_tx_rx_direct_gbe2_rxvldctr_user_data_in : out std_logic_vector( 32-1 downto 0 )
  );
...
begin
  rxvldctr_del2_q_net <= out_reg;
  zcu111_tengbe_tx_rx_direct_gbe2_rxvldctr_user_data_in <= cast_gw_dout_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
  io_delay : entity xil_defaultlib.sysgen_delay_1e4098e040 
  port map (
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txctr
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_txctr is
  port (
    ...
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    zcu111_tengbe_tx_rx_direct_gbe2_txctr_user_data_in : out std_logic_vector( 32-1 downto 0 )
  );
...
begin
  txctr_del2_q_net <= out_reg;
  zcu111_tengbe_tx_rx_direct_gbe2_txctr_user_data_in <= cast_gw_dout_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
  io_delay : entity xil_defaultlib.sysgen_delay_1e4098e040 
  port map (
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txctr_ed
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txfullctr
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_txfullctr is
  port (
    ...
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    zcu111_tengbe_tx_rx_direct_gbe2_txfullctr_user_data_in : out std_logic_vector( 32-1 downto 0 )
  );
...
begin
  txfullctr_del2_q_net <= out_reg;
  zcu111_tengbe_tx_rx_direct_gbe2_txfullctr_user_data_in <= cast_gw_dout_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
  io_delay : entity xil_defaultlib.sysgen_delay_1e4098e040 
  port map (
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txofctr
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_txofctr is
  port (
    ...
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    zcu111_tengbe_tx_rx_direct_gbe2_txofctr_user_data_in : out std_logic_vector( 32-1 downto 0 )
  );
...
begin
  txofctr_del2_q_net <= out_reg;
  zcu111_tengbe_tx_rx_direct_gbe2_txofctr_user_data_in <= cast_gw_dout_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
  io_delay : entity xil_defaultlib.sysgen_delay_1e4098e040 
  port map (
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/buscreate
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/io_delay
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/ss/add_gen/edge_detect
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/ss/add_gen
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/ss/basic_ctrl/dram_munge
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/ss/basic_ctrl/edge_detect
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/ss/basic_ctrl
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/ss/bram/calc_add
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/ss/bram/munge_in/join
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/ss/bram/munge_in/split
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/ss/bram/munge_in
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
begin
  dout <= reinterpret_out_output_port_net;
  dat_del_q_net <= din;
  join_x6 : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_join_x3 
  port map (
    in1 => reinterpret1_output_port_net,
    in2 => reinterpret2_output_port_net,
    in3 => reinterpret3_output_port_net,
  ...
  split_x6 : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_split_x3 
  port map (
    bus_in => reinterpret_output_port_net,
    msb_out4 => reinterpret4_output_port_net,
    out3 => reinterpret3_output_port_net,
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/ss/bram
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_bram is
  port (
    ...
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_addr : out std_logic_vector( 13-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_data_in : out std_logic_vector( 128-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_we : out std_logic_vector( 1-1 downto 0 )
  );
...
begin
  ...
  dat_del_q_net <= data_in;
  we_del_q_net <= we;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_addr <= convert_addr_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_data_in <= convert_din1_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_we <= convert_we_dout_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/ss/ctrl
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_ctrl is
  port (
    zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_ctrl_user_data_out : in std_logic_vector( 32-1 downto 0 );
    in_reg : out std_logic_vector( 32-1 downto 0 )
  );
end zcu111_tengbe_tx_rx_direct_ctrl;
architecture structural of zcu111_tengbe_tx_rx_direct_ctrl is 
  signal reint1_output_port_net : std_logic_vector( 32-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_ctrl_user_data_out_net : std_logic_vector( 32-1 downto 0 );
  signal io_delay_q_net : std_logic_vector( 32-1 downto 0 );
  signal slice_reg_y_net : std_logic_vector( 32-1 downto 0 );
begin
  in_reg <= reint1_output_port_net;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_ctrl_user_data_out_net <= zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_ctrl_user_data_out;
  io_delay : entity xil_defaultlib.sysgen_delay_71a4e0c2b5 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
    d => zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_ctrl_user_data_out_net,
    q => io_delay_q_net
  );
  slice_reg : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_xlslice 
  generic map (
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/ss/ctrl_combine
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/ss/ctrl_split
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/ss/status
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_status_x0 is
  port (
    ...
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_status_user_data_in : out std_logic_vector( 32-1 downto 0 )
  );
...
begin
  concat_y_net <= out_reg;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_status_user_data_in <= cast_gw_dout_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
  io_delay : entity xil_defaultlib.sysgen_delay_71a4e0c2b5 
  port map (
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/ss
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_ss_x0 is
  port (
    ...
    ce_1 : in std_logic;
    arm_out : out std_logic_vector( 1-1 downto 0 );
    goto_36471529_we1 : out std_logic_vector( 1-1 downto 0 );
    goto_36471529_we4 : out std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_addr : out std_logic_vector( 13-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_data_in : out std_logic_vector( 128-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_we : out std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_status_user_data_in : out std_logic_vector( 32-1 downto 0 )
...
begin
  ...
  register4_q_net_x1 <= we;
  register4_q_net_x2 <= trig;
  goto_36471529_we1 <= we_choice_y_net;
  goto_36471529_we4 <= logical6_y_net;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_addr <= convert_addr_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_data_in <= convert_din1_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_we <= convert_we_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_ctrl_user_data_out_net <= zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_ctrl_user_data_out;
  ...
  port map (
    zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_ctrl_user_data_out => zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_ctrl_user_data_out_net,
    in_reg => reint1_output_port_net
  );
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/trig_delay
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs/we_delay
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txs
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
architecture structural of zcu111_tengbe_tx_rx_direct_txs is 
  signal arm_or_y_net : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_led_up_net : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_led_tx_net : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_tx_afull_net : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_tx_overflow_net : std_logic_vector( 1-1 downto 0 );
  signal mux1_y_net : std_logic_vector( 1-1 downto 0 );
  signal mux2_y_net : std_logic_vector( 1-1 downto 0 );
  signal delay3_q_net : std_logic_vector( 64-1 downto 0 );
  signal reint1_output_port_net : std_logic_vector( 32-1 downto 0 );
...
begin
  arm_out <= arm_or_y_net;
  zcu111_tengbe_tx_rx_direct_gbe2_led_up_net <= in_link_up;
  zcu111_tengbe_tx_rx_direct_gbe2_led_tx_net <= in_led_tx;
  zcu111_tengbe_tx_rx_direct_gbe2_tx_afull_net <= in_tx_full;
  zcu111_tengbe_tx_rx_direct_gbe2_tx_overflow_net <= in_tx_over;
  mux1_y_net <= in_valid;
  mux2_y_net <= in_eof;
  delay3_q_net <= in_data;
  reint1_output_port_net <= in_ip;
  ...
  port map (
    din => zcu111_tengbe_tx_rx_direct_gbe2_led_tx_net,
    dout => assert_led_tx_dout_net
  );
  assert_tx_full : entity xil_defaultlib.xlpassthrough 
  generic map (
  ...
  port map (
    din => zcu111_tengbe_tx_rx_direct_gbe2_tx_afull_net,
    dout => assert_tx_full_dout_net
  );
  assert_tx_over : entity xil_defaultlib.xlpassthrough 
  generic map (
  ...
  port map (
    din => zcu111_tengbe_tx_rx_direct_gbe2_tx_overflow_net,
    dout => assert_tx_over_dout_net
  );
  assert_valid : entity xil_defaultlib.xlpassthrough 
  generic map (
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2/txvldctr
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_txvldctr is
  port (
    ...
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    zcu111_tengbe_tx_rx_direct_gbe2_txvldctr_user_data_in : out std_logic_vector( 32-1 downto 0 )
  );
...
begin
  txvldctr_del2_q_net <= out_reg;
  zcu111_tengbe_tx_rx_direct_gbe2_txvldctr_user_data_in <= cast_gw_dout_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
  io_delay : entity xil_defaultlib.sysgen_delay_1e4098e040 
  port map (
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_gbe2 is
  port (
    rst : in std_logic_vector( 1-1 downto 0 );
    tx_data : in std_logic_vector( 64-1 downto 0 );
    tx_valid : in std_logic_vector( 1-1 downto 0 );
    ...
    rx_overrun_ack : in std_logic_vector( 1-1 downto 0 );
    debug_rst : in std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_led_rx : in std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_led_tx : in std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_led_up : in std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rx_bad_frame : in std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rx_data : in std_logic_vector( 64-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rx_end_of_frame : in std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rx_overrun : in std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rx_source_ip : in std_logic_vector( 32-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rx_valid : in std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_tx_afull : in std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_tx_overflow : in std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out : in std_logic_vector( 32-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_ctrl_user_data_out : in std_logic_vector( 32-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    zcu111_tengbe_tx_rx_direct_gbe2_rst : out std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rx_ack : out std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rx_overrun_ack : out std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_tx_data : out std_logic_vector( 64-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_tx_dest_ip : out std_logic_vector( 32-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_tx_dest_port : out std_logic_vector( 16-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_tx_end_of_frame : out std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_tx_valid : out std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rxbadctr_user_data_in : out std_logic_vector( 32-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rxctr_user_data_in : out std_logic_vector( 32-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rxeofctr_user_data_in : out std_logic_vector( 32-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rxofctr_user_data_in : out std_logic_vector( 32-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_gbe2;
architecture structural of zcu111_tengbe_tx_rx_direct_gbe2 is 
  signal slice_core_rst_y_net : std_logic_vector( 1-1 downto 0 );
  signal delay3_q_net : std_logic_vector( 64-1 downto 0 );
  signal mux1_y_net : std_logic_vector( 1-1 downto 0 );
  signal reint1_output_port_net_x0 : std_logic_vector( 32-1 downto 0 );
...
begin
  ...
  delay2_q_net <= rx_overrun_ack;
  slice_cnt_rst_y_net <= debug_rst;
  zcu111_tengbe_tx_rx_direct_gbe2_led_rx_net <= zcu111_tengbe_tx_rx_direct_gbe2_led_rx;
  zcu111_tengbe_tx_rx_direct_gbe2_led_tx_net <= zcu111_tengbe_tx_rx_direct_gbe2_led_tx;
  zcu111_tengbe_tx_rx_direct_gbe2_led_up_net <= zcu111_tengbe_tx_rx_direct_gbe2_led_up;
  zcu111_tengbe_tx_rx_direct_gbe2_rst <= convert_rst_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_ack <= convert_rx_ack_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_bad_frame_net <= zcu111_tengbe_tx_rx_direct_gbe2_rx_bad_frame;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_data_net <= zcu111_tengbe_tx_rx_direct_gbe2_rx_data;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_end_of_frame_net <= zcu111_tengbe_tx_rx_direct_gbe2_rx_end_of_frame;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_overrun_net <= zcu111_tengbe_tx_rx_direct_gbe2_rx_overrun;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_overrun_ack <= convert_rx_overrun_ack_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_source_ip_net <= zcu111_tengbe_tx_rx_direct_gbe2_rx_source_ip;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_valid_net <= zcu111_tengbe_tx_rx_direct_gbe2_rx_valid;
  zcu111_tengbe_tx_rx_direct_gbe2_tx_afull_net <= zcu111_tengbe_tx_rx_direct_gbe2_tx_afull;
  zcu111_tengbe_tx_rx_direct_gbe2_tx_data <= convert_tx_data_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_tx_dest_ip <= convert_tx_dest_ip_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_tx_dest_port <= convert_tx_port_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_tx_end_of_frame <= convert_tx_end_of_frame_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_tx_overflow_net <= zcu111_tengbe_tx_rx_direct_gbe2_tx_overflow;
  zcu111_tengbe_tx_rx_direct_gbe2_tx_valid <= convert_tx_valid_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_rxbadctr_user_data_in <= cast_gw_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_rxctr_user_data_in <= cast_gw_dout_net_x0;
  zcu111_tengbe_tx_rx_direct_gbe2_rxeofctr_user_data_in <= cast_gw_dout_net_x1;
  zcu111_tengbe_tx_rx_direct_gbe2_rxofctr_user_data_in <= cast_gw_dout_net_x6;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_addr <= convert_addr_dout_net_x0;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_data_in <= convert_din1_dout_net_x0;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_we <= convert_we_dout_net_x0;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out_net <= zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_status_user_data_in <= cast_gw_dout_net_x5;
  zcu111_tengbe_tx_rx_direct_gbe2_rxvldctr_user_data_in <= cast_gw_dout_net_x4;
  zcu111_tengbe_tx_rx_direct_gbe2_txctr_user_data_in <= cast_gw_dout_net_x9;
  zcu111_tengbe_tx_rx_direct_gbe2_txfullctr_user_data_in <= cast_gw_dout_net_x7;
  zcu111_tengbe_tx_rx_direct_gbe2_txofctr_user_data_in <= cast_gw_dout_net_x8;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_addr <= convert_addr_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_data_in <= convert_din1_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_we <= convert_we_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_ctrl_user_data_out_net <= zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_ctrl_user_data_out;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_status_user_data_in <= cast_gw_dout_net_x3;
  zcu111_tengbe_tx_rx_direct_gbe2_txvldctr_user_data_in <= cast_gw_dout_net_x2;
  goto_113430955_we1 <= we_choice_y_net_x0;
  goto_113430955_we4 <= logical6_y_net;
  goto_36471529_we1 <= we_choice_y_net;
  goto_36471529_we4 <= logical6_y_net_x0;
  clk_net <= clk_1;
  ce_net <= ce_1;
  ...
  port map (
    in_led_up => zcu111_tengbe_tx_rx_direct_gbe2_led_up_net,
    in_led_rx => zcu111_tengbe_tx_rx_direct_gbe2_led_rx_net,
    in_data_in => zcu111_tengbe_tx_rx_direct_gbe2_rx_data_net,
    in_valid_in => zcu111_tengbe_tx_rx_direct_gbe2_rx_valid_net,
    in_ip_in => zcu111_tengbe_tx_rx_direct_gbe2_rx_source_ip_net,
    in_eof_in => zcu111_tengbe_tx_rx_direct_gbe2_rx_end_of_frame_net,
    in_bad_frame => zcu111_tengbe_tx_rx_direct_gbe2_rx_bad_frame_net,
    in_overrun => zcu111_tengbe_tx_rx_direct_gbe2_rx_overrun_net,
    trig => rxsnap_and_y_net,
    zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out => zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  port map (
    in_link_up => zcu111_tengbe_tx_rx_direct_gbe2_led_up_net,
    in_led_tx => zcu111_tengbe_tx_rx_direct_gbe2_led_tx_net,
    in_tx_full => zcu111_tengbe_tx_rx_direct_gbe2_tx_afull_net,
    in_tx_over => zcu111_tengbe_tx_rx_direct_gbe2_tx_overflow_net,
    in_valid => mux1_y_net,
    in_eof => mux2_y_net,
    in_data => delay3_q_net,
    in_ip => reint1_output_port_net_x0,
  ...
  port map (
    clr => '0',
    rst => rxbadctr_del1_q_net,
    en => zcu111_tengbe_tx_rx_direct_gbe2_rx_bad_frame_net,
    clk => clk_net,
    ce => ce_net,
    op => rxbadctr_ctr_op_net
  );
  ...
  port map (
    clr => '0',
    d0 => zcu111_tengbe_tx_rx_direct_gbe2_rx_end_of_frame_net,
    d1 => zcu111_tengbe_tx_rx_direct_gbe2_rx_valid_net,
    clk => clk_net,
    ce => ce_net,
    y => rxctr_and_y_net
  );
  ...
  port map (
    clr => '0',
    rst => rxeofctr_del1_q_net,
    en => zcu111_tengbe_tx_rx_direct_gbe2_rx_end_of_frame_net,
    clk => clk_net,
    ce => ce_net,
    op => rxeofctr_ctr_op_net
  );
  ...
  port map (
    clr => '0',
    rst => rxofctr_del1_q_net,
    en => zcu111_tengbe_tx_rx_direct_gbe2_rx_overrun_net,
    clk => clk_net,
    ce => ce_net,
    op => rxofctr_ctr_op_net
  );
  ...
  port map (
    clr => '0',
    d0 => zcu111_tengbe_tx_rx_direct_gbe2_rx_valid_net,
    d1 => zcu111_tengbe_tx_rx_direct_gbe2_rx_end_of_frame_net,
    clk => clk_net,
    ce => ce_net,
    y => rxsnap_and_y_net
  );
  ...
  port map (
    clr => '0',
    rst => rxvldctr_del1_q_net,
    en => zcu111_tengbe_tx_rx_direct_gbe2_rx_valid_net,
    clk => clk_net,
    ce => ce_net,
    op => rxvldctr_ctr_op_net
  );
  ...
  port map (
    clr => '0',
    rst => txfullctr_del1_q_net,
    en => zcu111_tengbe_tx_rx_direct_gbe2_tx_afull_net,
    clk => clk_net,
    ce => ce_net,
    op => txfullctr_ctr_op_net
  );
  ...
  port map (
    clr => '0',
    rst => txofctr_del1_q_net,
    en => zcu111_tengbe_tx_rx_direct_gbe2_tx_overflow_net,
    clk => clk_net,
    ce => ce_net,
    op => txofctr_ctr_op_net
  );
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/gbe2_linkup
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_gbe2_linkup is
  port (
    out_reg : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    zcu111_tengbe_tx_rx_direct_gbe2_linkup_user_data_in : out std_logic_vector( 32-1 downto 0 )
  );
end zcu111_tengbe_tx_rx_direct_gbe2_linkup;
architecture structural of zcu111_tengbe_tx_rx_direct_gbe2_linkup is 
  signal zcu111_tengbe_tx_rx_direct_gbe2_led_up_net : std_logic_vector( 1-1 downto 0 );
  signal cast_gw_dout_net : std_logic_vector( 32-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
  ...
  signal assert_reg_dout_net : std_logic_vector( 1-1 downto 0 );
begin
  zcu111_tengbe_tx_rx_direct_gbe2_led_up_net <= out_reg;
  zcu111_tengbe_tx_rx_direct_gbe2_linkup_user_data_in <= cast_gw_dout_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
  io_delay : entity xil_defaultlib.sysgen_delay_e09988964b 
  port map (
...
-- Generated from Simulink block zcu111_tengbe_tx_rx_direct/led4_gbe0_up
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_led4_gbe0_up is
  port (
    gpio_out : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    zcu111_tengbe_tx_rx_direct_led4_gbe0_up_gateway : out std_logic_vector( 1-1 downto 0 )
  );
end zcu111_tengbe_tx_rx_direct_led4_gbe0_up;
architecture structural of zcu111_tengbe_tx_rx_direct_led4_gbe0_up is 
  signal zcu111_tengbe_tx_rx_direct_gbe2_led_up_net : std_logic_vector( 1-1 downto 0 );
  signal convert_dout_net : std_logic_vector( 1-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
begin
  zcu111_tengbe_tx_rx_direct_gbe2_led_up_net <= gpio_out;
  zcu111_tengbe_tx_rx_direct_led4_gbe0_up_gateway <= convert_dout_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
  convert : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_xlconvert 
  generic map (
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_join_x4 is
  port (
    in1 : in std_logic_vector( 32-1 downto 0 );
    in2 : in std_logic_vector( 32-1 downto 0 );
    in3 : in std_logic_vector( 32-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_join_x4;
architecture structural of zcu111_tengbe_tx_rx_direct_join_x4 is 
  signal concatenate_y_net : std_logic_vector( 128-1 downto 0 );
  signal reinterpret1_output_port_net : std_logic_vector( 32-1 downto 0 );
  signal reinterpret2_output_port_net : std_logic_vector( 32-1 downto 0 );
  signal reinterpret3_output_port_net : std_logic_vector( 32-1 downto 0 );
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity zcu111_tengbe_tx_rx_direct_split_x4 is
  port (
    bus_in : in std_logic_vector( 128-1 downto 0 );
    msb_out4 : out std_logic_vector( 32-1 downto 0 );
    out3 : out std_logic_vector( 32-1 downto 0 );
...
end zcu111_tengbe_tx_rx_direct_split_x4;
architecture structural of zcu111_tengbe_tx_rx_direct_split_x4 is 
  signal reinterpret4_output_port_net : std_logic_vector( 32-1 downto 0 );
  signal reinterpret3_output_port_net : std_logic_vector( 32-1 downto 0 );
  signal reinterpret2_output_port_net : std_logic_vector( 32-1 downto 0 );
  signal reinterpret1_output_port_net : std_logic_vector( 32-1 downto 0 );
...
begin
  dout <= reinterpret_out_output_port_net;
  dat_del_q_net <= din;
  join_x6 : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_join_x4 
  port map (
    in1 => reinterpret1_output_port_net,
    in2 => reinterpret2_output_port_net,
    in3 => reinterpret3_output_port_net,
  ...
  split_x6 : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_split_x4 
  port map (
    bus_in => reinterpret_output_port_net,
    msb_out4 => reinterpret4_output_port_net,
    out3 => reinterpret3_output_port_net,
...
entity zcu111_tengbe_tx_rx_direct_struct is
  port (
    ...
    zcu111_tengbe_tx_rx_direct_gbe2_rx_overrun : in std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rx_source_ip : in std_logic_vector( 32-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rx_source_port : in std_logic_vector( 16-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rx_valid : in std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_tx_afull : in std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_tx_overflow : in std_logic_vector( 1-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_data_out : in std_logic_vector( 128-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out : in std_logic_vector( 32-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_data_out : in std_logic_vector( 128-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_ctrl_user_data_out : in std_logic_vector( 32-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_pkt_sim_enable_user_data_out : in std_logic_vector( 32-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_pkt_sim_payload_len_user_data_out : in std_logic_vector( 32-1 downto 0 );
    zcu111_tengbe_tx_rx_direct_pkt_sim_period_user_data_out : in std_logic_vector( 32-1 downto 0 );
...
architecture structural of zcu111_tengbe_tx_rx_direct_struct is 
  ...
  signal zcu111_tengbe_tx_rx_direct_gbe1_led_tx_net : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe1_led_up_net : std_logic_vector( 1-1 downto 0 );
  signal convert_rst_dout_net_x1 : std_logic_vector( 1-1 downto 0 );
  signal convert_rx_ack_dout_net_x1 : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe1_rx_bad_frame_net : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe1_rx_data_net : std_logic_vector( 64-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe1_rx_end_of_frame_net : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe1_rx_overrun_net : std_logic_vector( 1-1 downto 0 );
  signal convert_rx_overrun_ack_dout_net_x1 : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe1_rx_source_ip_net : std_logic_vector( 32-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe1_rx_source_port_net : std_logic_vector( 16-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe1_rx_valid_net : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe1_tx_afull_net : std_logic_vector( 1-1 downto 0 );
  signal convert_tx_data_dout_net_x1 : std_logic_vector( 64-1 downto 0 );
  signal convert_tx_dest_ip_dout_net_x1 : std_logic_vector( 32-1 downto 0 );
  signal convert_tx_port_dout_net_x1 : std_logic_vector( 16-1 downto 0 );
  signal convert_tx_end_of_frame_dout_net_x1 : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe1_tx_overflow_net : std_logic_vector( 1-1 downto 0 );
  signal convert_tx_valid_dout_net_x1 : std_logic_vector( 1-1 downto 0 );
  ...
  signal convert_addr_dout_net_x4 : std_logic_vector( 13-1 downto 0 );
  signal convert_din1_dout_net_x4 : std_logic_vector( 128-1 downto 0 );
  ...
  signal zcu111_tengbe_tx_rx_direct_gbe1_rxs_ss_ctrl_user_data_out_net : std_logic_vector( 32-1 downto 0 );
  signal cast_gw_dout_net_x41 : std_logic_vector( 32-1 downto 0 );
  signal cast_gw_dout_net_x40 : std_logic_vector( 32-1 downto 0 );
  signal cast_gw_dout_net_x39 : std_logic_vector( 32-1 downto 0 );
  signal cast_gw_dout_net_x38 : std_logic_vector( 32-1 downto 0 );
  signal cast_gw_dout_net_x37 : std_logic_vector( 32-1 downto 0 );
  signal convert_addr_dout_net_x5 : std_logic_vector( 13-1 downto 0 );
  signal convert_din1_dout_net_x5 : std_logic_vector( 128-1 downto 0 );
  ...
  signal zcu111_tengbe_tx_rx_direct_gbe2_rx_source_ip_net : std_logic_vector( 32-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_rx_source_port_net : std_logic_vector( 16-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_rx_valid_net : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_gbe2_tx_afull_net : std_logic_vector( 1-1 downto 0 );
  ...
  signal zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_data_out_net : std_logic_vector( 128-1 downto 0 );
  ...
  signal zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_data_out_net : std_logic_vector( 128-1 downto 0 );
  ...
  signal convert_dout_net_x3 : std_logic_vector( 1-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_pkt_sim_enable_user_data_out_net : std_logic_vector( 32-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_pkt_sim_payload_len_user_data_out_net : std_logic_vector( 32-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_pkt_sim_period_user_data_out_net : std_logic_vector( 32-1 downto 0 );
  signal zcu111_tengbe_tx_rx_direct_rst_user_data_out_net : std_logic_vector( 32-1 downto 0 );
...
begin
  ...
  zcu111_tengbe_tx_rx_direct_gbe0_tx_overflow_net <= zcu111_tengbe_tx_rx_direct_gbe0_tx_overflow;
  zcu111_tengbe_tx_rx_direct_gbe0_tx_valid <= convert_tx_valid_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe0_rxbadctr_user_data_in <= cast_gw_dout_net_x2;
  zcu111_tengbe_tx_rx_direct_gbe0_rxctr_user_data_in <= cast_gw_dout_net_x1;
  zcu111_tengbe_tx_rx_direct_gbe0_rxeofctr_user_data_in <= cast_gw_dout_net_x0;
  zcu111_tengbe_tx_rx_direct_gbe0_rxofctr_user_data_in <= cast_gw_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe0_rxs_ss_bram_addr <= convert_addr_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe0_rxs_ss_bram_data_in <= convert_din1_dout_net;
  ...
  zcu111_tengbe_tx_rx_direct_gbe0_rxs_ss_bram_we <= convert_we_dout_net;
  zcu111_tengbe_tx_rx_direct_gbe0_rxs_ss_ctrl_user_data_out_net <= zcu111_tengbe_tx_rx_direct_gbe0_rxs_ss_ctrl_user_data_out;
  zcu111_tengbe_tx_rx_direct_gbe0_rxs_ss_status_user_data_in <= cast_gw_dout_net_x9;
  zcu111_tengbe_tx_rx_direct_gbe0_rxvldctr_user_data_in <= cast_gw_dout_net_x8;
  zcu111_tengbe_tx_rx_direct_gbe0_txctr_user_data_in <= cast_gw_dout_net_x7;
  zcu111_tengbe_tx_rx_direct_gbe0_txfullctr_user_data_in <= cast_gw_dout_net_x6;
  zcu111_tengbe_tx_rx_direct_gbe0_txofctr_user_data_in <= cast_gw_dout_net_x5;
  zcu111_tengbe_tx_rx_direct_gbe0_txs_ss_bram_addr <= convert_addr_dout_net_x0;
  zcu111_tengbe_tx_rx_direct_gbe0_txs_ss_bram_data_in <= convert_din1_dout_net_x0;
  zcu111_tengbe_tx_rx_direct_gbe0_txs_ss_bram_data_out_net <= zcu111_tengbe_tx_rx_direct_gbe0_txs_ss_bram_data_out;
  zcu111_tengbe_tx_rx_direct_gbe0_txs_ss_bram_we <= convert_we_dout_net_x0;
  zcu111_tengbe_tx_rx_direct_gbe0_txs_ss_ctrl_user_data_out_net <= zcu111_tengbe_tx_rx_direct_gbe0_txs_ss_ctrl_user_data_out;
  zcu111_tengbe_tx_rx_direct_gbe0_txs_ss_status_user_data_in <= cast_gw_dout_net_x4;
  zcu111_tengbe_tx_rx_direct_gbe0_txvldctr_user_data_in <= cast_gw_dout_net_x3;
  zcu111_tengbe_tx_rx_direct_gbe0_linkup_user_data_in <= cast_gw_dout_net_x34;
  zcu111_tengbe_tx_rx_direct_gbe0_tx_cnt_user_data_in <= cast_gw_dout_net_x33;
  zcu111_tengbe_tx_rx_direct_gbe1_led_rx_net <= zcu111_tengbe_tx_rx_direct_gbe1_led_rx;
  zcu111_tengbe_tx_rx_direct_gbe1_led_tx_net <= zcu111_tengbe_tx_rx_direct_gbe1_led_tx;
  zcu111_tengbe_tx_rx_direct_gbe1_led_up_net <= zcu111_tengbe_tx_rx_direct_gbe1_led_up;
  zcu111_tengbe_tx_rx_direct_gbe1_rst <= convert_rst_dout_net_x1;
  zcu111_tengbe_tx_rx_direct_gbe1_rx_ack <= convert_rx_ack_dout_net_x1;
  zcu111_tengbe_tx_rx_direct_gbe1_rx_bad_frame_net <= zcu111_tengbe_tx_rx_direct_gbe1_rx_bad_frame;
  zcu111_tengbe_tx_rx_direct_gbe1_rx_data_net <= zcu111_tengbe_tx_rx_direct_gbe1_rx_data;
  zcu111_tengbe_tx_rx_direct_gbe1_rx_end_of_frame_net <= zcu111_tengbe_tx_rx_direct_gbe1_rx_end_of_frame;
  zcu111_tengbe_tx_rx_direct_gbe1_rx_overrun_net <= zcu111_tengbe_tx_rx_direct_gbe1_rx_overrun;
  zcu111_tengbe_tx_rx_direct_gbe1_rx_overrun_ack <= convert_rx_overrun_ack_dout_net_x1;
  zcu111_tengbe_tx_rx_direct_gbe1_rx_source_ip_net <= zcu111_tengbe_tx_rx_direct_gbe1_rx_source_ip;
  zcu111_tengbe_tx_rx_direct_gbe1_rx_source_port_net <= zcu111_tengbe_tx_rx_direct_gbe1_rx_source_port;
  zcu111_tengbe_tx_rx_direct_gbe1_rx_valid_net <= zcu111_tengbe_tx_rx_direct_gbe1_rx_valid;
  zcu111_tengbe_tx_rx_direct_gbe1_tx_afull_net <= zcu111_tengbe_tx_rx_direct_gbe1_tx_afull;
  zcu111_tengbe_tx_rx_direct_gbe1_tx_data <= convert_tx_data_dout_net_x1;
  zcu111_tengbe_tx_rx_direct_gbe1_tx_dest_ip <= convert_tx_dest_ip_dout_net_x1;
  zcu111_tengbe_tx_rx_direct_gbe1_tx_dest_port <= convert_tx_port_dout_net_x1;
  zcu111_tengbe_tx_rx_direct_gbe1_tx_end_of_frame <= convert_tx_end_of_frame_dout_net_x1;
  zcu111_tengbe_tx_rx_direct_gbe1_tx_overflow_net <= zcu111_tengbe_tx_rx_direct_gbe1_tx_overflow;
  zcu111_tengbe_tx_rx_direct_gbe1_tx_valid <= convert_tx_valid_dout_net_x1;
  zcu111_tengbe_tx_rx_direct_gbe1_rxbadctr_user_data_in <= cast_gw_dout_net_x32;
  zcu111_tengbe_tx_rx_direct_gbe1_rxctr_user_data_in <= cast_gw_dout_net_x31;
  zcu111_tengbe_tx_rx_direct_gbe1_rxeofctr_user_data_in <= cast_gw_dout_net_x30;
  zcu111_tengbe_tx_rx_direct_gbe1_rxofctr_user_data_in <= cast_gw_dout_net_x29;
  zcu111_tengbe_tx_rx_direct_gbe1_rxs_ss_bram_addr <= convert_addr_dout_net_x4;
  zcu111_tengbe_tx_rx_direct_gbe1_rxs_ss_bram_data_in <= convert_din1_dout_net_x4;
  zcu111_tengbe_tx_rx_direct_gbe1_rxs_ss_bram_data_out_net <= zcu111_tengbe_tx_rx_direct_gbe1_rxs_ss_bram_data_out;
  zcu111_tengbe_tx_rx_direct_gbe1_rxs_ss_bram_we <= convert_we_dout_net_x4;
  zcu111_tengbe_tx_rx_direct_gbe1_rxs_ss_ctrl_user_data_out_net <= zcu111_tengbe_tx_rx_direct_gbe1_rxs_ss_ctrl_user_data_out;
  zcu111_tengbe_tx_rx_direct_gbe1_rxs_ss_status_user_data_in <= cast_gw_dout_net_x41;
  zcu111_tengbe_tx_rx_direct_gbe1_rxvldctr_user_data_in <= cast_gw_dout_net_x40;
  zcu111_tengbe_tx_rx_direct_gbe1_txctr_user_data_in <= cast_gw_dout_net_x39;
  zcu111_tengbe_tx_rx_direct_gbe1_txfullctr_user_data_in <= cast_gw_dout_net_x38;
  zcu111_tengbe_tx_rx_direct_gbe1_txofctr_user_data_in <= cast_gw_dout_net_x37;
  zcu111_tengbe_tx_rx_direct_gbe1_txs_ss_bram_addr <= convert_addr_dout_net_x5;
  zcu111_tengbe_tx_rx_direct_gbe1_txs_ss_bram_data_in <= convert_din1_dout_net_x5;
  zcu111_tengbe_tx_rx_direct_gbe1_txs_ss_bram_data_out_net <= zcu111_tengbe_tx_rx_direct_gbe1_txs_ss_bram_data_out;
  zcu111_tengbe_tx_rx_direct_gbe1_txs_ss_bram_we <= convert_we_dout_net_x5;
  zcu111_tengbe_tx_rx_direct_gbe1_txs_ss_ctrl_user_data_out_net <= zcu111_tengbe_tx_rx_direct_gbe1_txs_ss_ctrl_user_data_out;
  zcu111_tengbe_tx_rx_direct_gbe1_txs_ss_status_user_data_in <= cast_gw_dout_net_x36;
  zcu111_tengbe_tx_rx_direct_gbe1_txvldctr_user_data_in <= cast_gw_dout_net_x35;
  zcu111_tengbe_tx_rx_direct_gbe1_linkup_user_data_in <= cast_gw_dout_net_x21;
  zcu111_tengbe_tx_rx_direct_gbe1_rx_frame_cnt_user_data_in <= cast_gw_dout_net_x20;
  zcu111_tengbe_tx_rx_direct_gbe2_led_rx_net <= zcu111_tengbe_tx_rx_direct_gbe2_led_rx;
  zcu111_tengbe_tx_rx_direct_gbe2_led_tx_net <= zcu111_tengbe_tx_rx_direct_gbe2_led_tx;
  zcu111_tengbe_tx_rx_direct_gbe2_led_up_net <= zcu111_tengbe_tx_rx_direct_gbe2_led_up;
  zcu111_tengbe_tx_rx_direct_gbe2_rst <= convert_rst_dout_net_x0;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_ack <= convert_rx_ack_dout_net_x0;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_bad_frame_net <= zcu111_tengbe_tx_rx_direct_gbe2_rx_bad_frame;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_data_net <= zcu111_tengbe_tx_rx_direct_gbe2_rx_data;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_end_of_frame_net <= zcu111_tengbe_tx_rx_direct_gbe2_rx_end_of_frame;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_overrun_net <= zcu111_tengbe_tx_rx_direct_gbe2_rx_overrun;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_overrun_ack <= convert_rx_overrun_ack_dout_net_x0;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_source_ip_net <= zcu111_tengbe_tx_rx_direct_gbe2_rx_source_ip;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_source_port_net <= zcu111_tengbe_tx_rx_direct_gbe2_rx_source_port;
  zcu111_tengbe_tx_rx_direct_gbe2_rx_valid_net <= zcu111_tengbe_tx_rx_direct_gbe2_rx_valid;
  zcu111_tengbe_tx_rx_direct_gbe2_tx_afull_net <= zcu111_tengbe_tx_rx_direct_gbe2_tx_afull;
  zcu111_tengbe_tx_rx_direct_gbe2_tx_data <= convert_tx_data_dout_net_x0;
  zcu111_tengbe_tx_rx_direct_gbe2_tx_dest_ip <= convert_tx_dest_ip_dout_net_x0;
  zcu111_tengbe_tx_rx_direct_gbe2_tx_dest_port <= convert_tx_port_dout_net_x0;
  zcu111_tengbe_tx_rx_direct_gbe2_tx_end_of_frame <= convert_tx_end_of_frame_dout_net_x0;
  zcu111_tengbe_tx_rx_direct_gbe2_tx_overflow_net <= zcu111_tengbe_tx_rx_direct_gbe2_tx_overflow;
  zcu111_tengbe_tx_rx_direct_gbe2_tx_valid <= convert_tx_valid_dout_net_x0;
  zcu111_tengbe_tx_rx_direct_gbe2_rxbadctr_user_data_in <= cast_gw_dout_net_x19;
  zcu111_tengbe_tx_rx_direct_gbe2_rxctr_user_data_in <= cast_gw_dout_net_x18;
  zcu111_tengbe_tx_rx_direct_gbe2_rxeofctr_user_data_in <= cast_gw_dout_net_x17;
  zcu111_tengbe_tx_rx_direct_gbe2_rxofctr_user_data_in <= cast_gw_dout_net_x16;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_addr <= convert_addr_dout_net_x2;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_data_in <= convert_din1_dout_net_x2;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_data_out_net <= zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_data_out;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_bram_we <= convert_we_dout_net_x2;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out_net <= zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out;
  zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_status_user_data_in <= cast_gw_dout_net_x28;
  zcu111_tengbe_tx_rx_direct_gbe2_rxvldctr_user_data_in <= cast_gw_dout_net_x27;
  zcu111_tengbe_tx_rx_direct_gbe2_txctr_user_data_in <= cast_gw_dout_net_x26;
  zcu111_tengbe_tx_rx_direct_gbe2_txfullctr_user_data_in <= cast_gw_dout_net_x25;
  zcu111_tengbe_tx_rx_direct_gbe2_txofctr_user_data_in <= cast_gw_dout_net_x24;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_addr <= convert_addr_dout_net_x3;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_data_in <= convert_din1_dout_net_x3;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_data_out_net <= zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_data_out;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_bram_we <= convert_we_dout_net_x3;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_ctrl_user_data_out_net <= zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_ctrl_user_data_out;
  zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_status_user_data_in <= cast_gw_dout_net_x23;
  zcu111_tengbe_tx_rx_direct_gbe2_txvldctr_user_data_in <= cast_gw_dout_net_x22;
  zcu111_tengbe_tx_rx_direct_gbe2_linkup_user_data_in <= cast_gw_dout_net_x15;
  zcu111_tengbe_tx_rx_direct_led0_gbe0_pulse_tx_gateway <= convert_dout_net;
  ...
  zcu111_tengbe_tx_rx_direct_led4_gbe0_up_gateway <= convert_dout_net_x3;
  zcu111_tengbe_tx_rx_direct_pkt_sim_enable_user_data_out_net <= zcu111_tengbe_tx_rx_direct_pkt_sim_enable_user_data_out;
  zcu111_tengbe_tx_rx_direct_pkt_sim_payload_len_user_data_out_net <= zcu111_tengbe_tx_rx_direct_pkt_sim_payload_len_user_data_out;
  zcu111_tengbe_tx_rx_direct_pkt_sim_period_user_data_out_net <= zcu111_tengbe_tx_rx_direct_pkt_sim_period_user_data_out;
  zcu111_tengbe_tx_rx_direct_rst_user_data_out_net <= zcu111_tengbe_tx_rx_direct_rst_user_data_out;
  zcu111_tengbe_tx_rx_direct_rx_bad_frame_user_data_in <= cast_gw_dout_net_x10;
  zcu111_tengbe_tx_rx_direct_rx_end_of_frame_user_data_in <= cast_gw_dout_net_x11;
  zcu111_tengbe_tx_rx_direct_rx_source_ip_user_data_in <= cast_gw_dout_net_x12;
  zcu111_tengbe_tx_rx_direct_rx_source_port_user_data_in <= cast_gw_dout_net_x13;
  zcu111_tengbe_tx_rx_direct_tx_snapshot_ss_bram_addr <= convert_addr_dout_net_x1;
  zcu111_tengbe_tx_rx_direct_tx_snapshot_ss_bram_data_in <= convert_din1_dout_net_x1;
  zcu111_tengbe_tx_rx_direct_tx_snapshot_ss_bram_data_out_net <= zcu111_tengbe_tx_rx_direct_tx_snapshot_ss_bram_data_out;
  zcu111_tengbe_tx_rx_direct_tx_snapshot_ss_bram_we <= convert_we_dout_net_x1;
  zcu111_tengbe_tx_rx_direct_tx_snapshot_ss_ctrl_user_data_out_net <= zcu111_tengbe_tx_rx_direct_tx_snapshot_ss_ctrl_user_data_out;
  zcu111_tengbe_tx_rx_direct_tx_snapshot_ss_status_user_data_in <= cast_gw_dout_net_x14;
  clk_net <= clk_1;
  ce_net <= ce_1;
  ...
  port map (
    ...
    goto_117471213_we1 => we_choice_y_net,
    goto_117471213_we4 => logical6_y_net,
    goto_40511787_we1 => we_choice_y_net_x0,
    goto_40511787_we4 => logical6_y_net_x0
  );
  ...
  port map (
    ...
    zcu111_tengbe_tx_rx_direct_gbe1_txs_ss_status_user_data_in => cast_gw_dout_net_x36,
    zcu111_tengbe_tx_rx_direct_gbe1_txvldctr_user_data_in => cast_gw_dout_net_x35,
    goto_115451084_we1 => we_choice_y_net_x4,
    goto_115451084_we4 => logical6_y_net_x4,
    goto_38491658_we1 => we_choice_y_net_x5,
    goto_38491658_we4 => logical6_y_net_x5
  );
  ...
  gbe2 : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_gbe2 
  port map (
    rst => slice_core_rst_y_net,
    tx_data => delay3_q_net,
    tx_valid => mux1_y_net,
    ...
    rx_overrun_ack => delay2_q_net,
    debug_rst => slice_cnt_rst_y_net,
    zcu111_tengbe_tx_rx_direct_gbe2_led_rx => zcu111_tengbe_tx_rx_direct_gbe2_led_rx_net,
    zcu111_tengbe_tx_rx_direct_gbe2_led_tx => zcu111_tengbe_tx_rx_direct_gbe2_led_tx_net,
    zcu111_tengbe_tx_rx_direct_gbe2_led_up => zcu111_tengbe_tx_rx_direct_gbe2_led_up_net,
    zcu111_tengbe_tx_rx_direct_gbe2_rx_bad_frame => zcu111_tengbe_tx_rx_direct_gbe2_rx_bad_frame_net,
    zcu111_tengbe_tx_rx_direct_gbe2_rx_data => zcu111_tengbe_tx_rx_direct_gbe2_rx_data_net,
    zcu111_tengbe_tx_rx_direct_gbe2_rx_end_of_frame => zcu111_tengbe_tx_rx_direct_gbe2_rx_end_of_frame_net,
    zcu111_tengbe_tx_rx_direct_gbe2_rx_overrun => zcu111_tengbe_tx_rx_direct_gbe2_rx_overrun_net,
    zcu111_tengbe_tx_rx_direct_gbe2_rx_source_ip => zcu111_tengbe_tx_rx_direct_gbe2_rx_source_ip_net,
    zcu111_tengbe_tx_rx_direct_gbe2_rx_valid => zcu111_tengbe_tx_rx_direct_gbe2_rx_valid_net,
    zcu111_tengbe_tx_rx_direct_gbe2_tx_afull => zcu111_tengbe_tx_rx_direct_gbe2_tx_afull_net,
    zcu111_tengbe_tx_rx_direct_gbe2_tx_overflow => zcu111_tengbe_tx_rx_direct_gbe2_tx_overflow_net,
    zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out => zcu111_tengbe_tx_rx_direct_gbe2_rxs_ss_ctrl_user_data_out_net,
    zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_ctrl_user_data_out => zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_ctrl_user_data_out_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
    ...
    zcu111_tengbe_tx_rx_direct_gbe2_txs_ss_status_user_data_in => cast_gw_dout_net_x23,
    zcu111_tengbe_tx_rx_direct_gbe2_txvldctr_user_data_in => cast_gw_dout_net_x22,
    goto_113430955_we1 => we_choice_y_net_x2,
    goto_113430955_we4 => logical6_y_net_x2,
    goto_36471529_we1 => we_choice_y_net_x3,
    goto_36471529_we4 => logical6_y_net_x3
  );
  gbe2_linkup : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_gbe2_linkup 
  port map (
    out_reg => zcu111_tengbe_tx_rx_direct_gbe2_led_up_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
    zcu111_tengbe_tx_rx_direct_gbe2_linkup_user_data_in => cast_gw_dout_net_x15
  );
  ...
  led4_gbe0_up : entity xil_defaultlib.zcu111_tengbe_tx_rx_direct_led4_gbe0_up 
  port map (
    gpio_out => zcu111_tengbe_tx_rx_direct_gbe2_led_up_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
    zcu111_tengbe_tx_rx_direct_led4_gbe0_up_gateway => convert_dout_net_x3
  );
  ...
  port map (
    ...
    zcu111_tengbe_tx_rx_direct_tx_snapshot_ss_bram_we => convert_we_dout_net_x1,
    zcu111_tengbe_tx_rx_direct_tx_snapshot_ss_status_user_data_in => cast_gw_dout_net_x14,
    goto_4569742_we1 => we_choice_y_net_x1,
    goto_4569742_we4 => logical6_y_net_x1
  );
  ...
  port map (
    clr => '0',
    d => zcu111_tengbe_tx_rx_direct_gbe2_rx_bad_frame_net,
    clk => clk_net,
    ce => ce_net,
    q => delay2_q_net
  );
