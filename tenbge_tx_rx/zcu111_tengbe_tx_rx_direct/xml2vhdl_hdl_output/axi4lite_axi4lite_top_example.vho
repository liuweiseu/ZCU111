...
begin
   ...
   axi4lite_gbe0_inst: entity work.axi4lite_gbe0
   port map(
      axi4lite_aclk => axi4lite_aclk,
      axi4lite_aresetn => axi4lite_aresetn,
      axi4lite_mosi => axi4lite_mosi_arr(axi4lite_mmap_get_id(id_gbe0)),
      axi4lite_miso => axi4lite_miso_arr(axi4lite_mmap_get_id(id_gbe0))
   );
   
   axi4lite_gbe0_rxs_ss_bram_inst: entity work.axi4lite_gbe0_rxs_ss_bram
   port map(
      axi4lite_aclk => axi4lite_aclk,
      axi4lite_aresetn => axi4lite_aresetn,
   ...
   axi4lite_gbe0_txs_ss_bram_inst: entity work.axi4lite_gbe0_txs_ss_bram
   port map(
      axi4lite_aclk => axi4lite_aclk,
      axi4lite_aresetn => axi4lite_aresetn,
   ...
   axi4lite_gbe1_inst: entity work.axi4lite_gbe1
   port map(
      axi4lite_aclk => axi4lite_aclk,
      axi4lite_aresetn => axi4lite_aresetn,
      axi4lite_mosi => axi4lite_mosi_arr(axi4lite_mmap_get_id(id_gbe1)),
      axi4lite_miso => axi4lite_miso_arr(axi4lite_mmap_get_id(id_gbe1))
   );
   
   axi4lite_gbe1_rxs_ss_bram_inst: entity work.axi4lite_gbe1_rxs_ss_bram
   port map(
      axi4lite_aclk => axi4lite_aclk,
      axi4lite_aresetn => axi4lite_aresetn,
   ...
   axi4lite_gbe1_txs_ss_bram_inst: entity work.axi4lite_gbe1_txs_ss_bram
   port map(
      axi4lite_aclk => axi4lite_aclk,
      axi4lite_aresetn => axi4lite_aresetn,
   ...
   axi4lite_tx_snapshot_ss_bram_inst: entity work.axi4lite_tx_snapshot_ss_bram
   port map(
      axi4lite_aclk => axi4lite_aclk,
      axi4lite_aresetn => axi4lite_aresetn,
