...
entity rfdc_one_adc_4096gsps_stub is
  port (
...
end rfdc_one_adc_4096gsps_stub;
architecture structural of rfdc_one_adc_4096gsps_stub is 
begin
  sysgen_dut : entity xil_defaultlib.rfdc_one_adc_4096gsps 
  port map (
